...
export const BACKUP_GENERAL = {
  ...
  socialGithub: 'https://github.com/josburflor',
  socialLinkedin: 'https://linkedin.com/in/joseburgosflores/',
  socialInstagram: 'https://instagram.com/josburflor/',
  socialYoutube: 'https://youtube.com/@josburflor',
  hiddenIds: [],
  cvUrl: '',
  menuItems: [
...
export const BACKUP_PROJECTS = [
  { 
    ...
    description: 'Plataforma de comercio electrónico de alta disponibilidad con gestión automatizada.',
    link: '#'
  },
  { 
    id: 'init-p2', 
    ...
    description: 'Centralización de sistemas de seguridad con monitoreo en tiempo real y alertas inteligentes.',
    link: '#'
  },
  { 
    id: 'init-p3', 
  ...
  { 
    ...
    description: 'Aplicación móvil híbrida para la gestión de equipos remotos y comunicación interna.',
    link: '#'
  }
];

export const BACKUP_SKILLS = [
  { id: 'init-s1', name: 'Frontend React', level: 95, icon: 'github' },
  { id: 'init-s2', name: 'Inteligencia Artificial', level: 85, icon: 'cpu' },
  { id: 'init-s3', name: 'Diseño Web Full', level: 98, icon: 'globe' },
  { id: 'init-s4', name: 'Arquitectura Cloud', level: 90, icon: 'terminal' }
];

export const BACKUP_TESTIMONIALS = [
  {
    id: 't1',
